...
{% assign no_show_cat = "[Recettes asiatiques] [boissons & cocktails] [cuissons & préparations] desserts entrées plats" %} <!--permet d'assigner une catégorie à la liste "no_show_cat"-->
